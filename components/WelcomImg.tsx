export const WelcomeImg = () => (
  <svg
    ...
    className="welcome-image mt-8 xl:mt-0"
  ...
  >
    <defs>
      ...
      <linearGradient
        ...
        xlinkHref="#b96c1e95-21f7-460f-8fe8-281b03b6a731"
      />
      <linearGradient
    ...
    <rect x="5.2" y="6.93" width="434.74" height="78.81" fill="#63a8ff" />
    ...
    <rect x="236.48" y="168.46" width="541.97" height="98.24" fill="#63a8ff" />
